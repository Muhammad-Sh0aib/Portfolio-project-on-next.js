...
const Education = () => {
  ...
  return (
    <div className={styles.EducationSection} id="Education">
      ...
      <div className={`${edu}`}>
        <div className={styles.MainContainer}>
          <div className={styles.dateContainer}>
            <div className={styles.date}><p>Sep 2020 - Present</p></div>
            <div className={styles.date}><p>Sep 2017 - June 2019</p></div>
            <div className={styles.date}><p>April 2015 - May 2017</p></div>
          </div>
      ...
      <div className={styles.MainContainer}>
          <div className={styles.dateContainer}>
            <div className={styles.date}><p>June 2022 - Present</p></div>
            <div className={styles.date}><p>Dec 2022 - Present</p></div>
            <div className={styles.date}><p>May 2021 - Aug 2021</p></div>
          </div>
          <div className={styles.detailContainer}>
            <div className={styles.Detail}>
